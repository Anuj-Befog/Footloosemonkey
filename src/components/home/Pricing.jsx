    ...
    <div className="bg-[aliceblue] p-16">
      ...
      <div className="flex flex-col md:flex-row justify-center space-y-10 md:space-y-0 md:space-x-10">
        ...
        <div className="bg-white p-8 shadow-xl rounded-lg text-center w-full md:w-1/3">
          <Image src="/pricing/young-performers.jpg" alt="Young Performers" width={300} height={200} className="mx-auto rounded-lg mb-6" />
        ...
        {/* Plan for 9-12 years */}
        <div className="bg-white p-8 shadow-xl rounded-lg text-center w-full md:w-1/3">
          <Image src="/pricing/older-performers.jpg" alt="Older Performers" width={300} height={200} className="mx-auto rounded-lg mb-6" />
