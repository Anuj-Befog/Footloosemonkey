            ...
            <div className='border-b-2 border-gray-300'>
                <nav className='flex items-center justify-between p-4 bg-gray-100'>
                    ...
                    <div className='hidden items-center md:flex space-x-6'>
                        ...
                        >
                            <div
                                class="flex rounded-full items-center justify-center w-full transition-all duration-300 group-hover:justify-start group-hover:px-3"
                            >
                            ...
                            <div
                                class="absolute rounded-full right-5 transform translate-x-full opacity-0 text-white text-lg font-semibold transition-all duration-300 group-hover:translate-x-0 group-hover:opacity-100"
                            >
                                Logout
                            </div>
                        </button>
                        ...
                        {/* Menu Bar */}
                        <button className='hidden text-xl font-bold text-black md:hidden' onClick={() => setIsNavbarOpen(!isNavbarOpen)}>
                            ☰
                        </button>
                    </div>
