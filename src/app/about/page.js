            ...
            <div className="container mx-auto px-8 py-16">
                ...
                <div className="text-center mb-12">
                    <p className="text-xl leading-8 text-gray-700">
                        Welcome to Footloosemonkey, the ultimate platform for young and talented performers! We are passionate about giving children aged 6-15 a stage to express their creativity in singing, dancing, acting, and mimicry. Our mission is to inspire confidence, nurture talent, and create stars in a fun, supportive, and safe environment.
                    </p>
                ...
                <div className="grid grid-cols-2 gap-12">
                    <div className="bg-white shadow-lg p-6 rounded-lg">
                        <Image src="/about/performers.jpg" alt="Performers on stage" width={500} height={350} className="rounded-lg" />
                    ...
                    <div className="bg-white shadow-lg p-6 rounded-lg">
                        <Image src="/about/dancers.jpg" alt="Dancers performing" width={500} height={350} className="rounded-lg" />
                        ...
                        <ul className="list-disc list-inside text-xl text-gray-600 mt-4 space-y-3">
                            ...
                            <li>A platform to meet and collaborate with other young performers</li>
                ...
                <div className="mt-16">
                    ...
                    <div className="grid grid-cols-3 gap-10">
                        <div className="bg-white p-8 shadow-md rounded-md text-center">
                            <Image src="/about/singing.jpg" alt="Singing" width={250} height={180} className="rounded-md mx-auto" />
                        ...
                        <div className="bg-white p-8 shadow-md rounded-md text-center">
                            <Image src="/about/dance.jpg" alt="Dancing" width={250} height={180} className="rounded-md mx-auto" />
                        ...
                        <div className="bg-white p-8 shadow-md rounded-md text-center">
                            <Image src="/about/acting.jpg" alt="Acting" width={250} height={180} className="rounded-md mx-auto" />
                ...
                <div className="mt-32">
                    ...
                    <div className="flex flex-col md:flex-row justify-center items-center space-y-12 md:space-y-0 md:space-x-10">
                        ...
                        <div className="bg-white p-8 shadow-2xl rounded-xl w-full md:w-1/3 relative">
                            <Image src="/pricing/young-performers.jpg" alt="Young Performers" width={350} height={250} className="rounded-xl mx-auto" />
                            ...
                            <button className="mt-8 bg-sky-700 hover:bg-sky-800 text-white py-3 px-8 rounded-full transition">Get Started</button>
                        </div>

                        {/* Card for 9-12 years */}
                        <div className="bg-white p-8 shadow-2xl rounded-xl w-full md:w-1/3 relative">
                            <Image src="/pricing/older-performers.jpg" alt="Older Performers" width={350} height={250} className="rounded-xl mx-auto" />
                            ...
                            <button className="mt-8 bg-cyan-600 hover:bg-cyan-700 text-white py-3 px-8 rounded-full transition">Join Now</button>
                        </div>
                    </div>
                </div>
                ...
                <div className="text-center mt-24">
                    ...
                    <div className="mt-10">
                        <Image src="/about/register-now.png" alt="Register now" width={300} height={100} className="mx-auto cursor-pointer" />
                    </div>
                </div>
            </div>
        </div>
